...
export const useSettingsStore = defineStore('settings', {
	state: () => ({
		...
		gitDescribe: import.meta.env.VITE_VUE_APP_GIT_DESCRIBE != null ? JSON.parse(import.meta.env.VITE_VUE_APP_GIT_DESCRIBE) : null,
		environment: runtimeConfig.ENV_LABEL || import.meta.env.VITE_VUE_APP_ENV_LABEL || 'local',
		dataPath: runtimeConfig.API_PATH || import.meta.env.VITE_VUE_APP_API_PATH,
		// apiPath: runtimeConfig.API_PATH || import.meta.env.VITE_VUE_APP_API_PATH,
		apiPath: 'http://libris.kb.se.localhost:5000',
		verifyPath: runtimeConfig.VERIFY_PATH || import.meta.env.VITE_VUE_APP_VERIFY_PATH,
		idPath: runtimeConfig.ID_PATH || import.meta.env.VITE_VUE_APP_ID_PATH,
		idPath: 'http://id.kb.se.localhost:5000',
		authPath: runtimeConfig.AUTHORIZE_PATH || import.meta.env.VITE_VUE_APP_AUTHORIZE_PATH,
		redirectPath: runtimeConfig.REDIRECT_PATH || import.meta.env.VITE_VUE_APP_REDIRECT_PATH,
		clientId: runtimeConfig.CLIENT_ID || import.meta.env.VITE_VUE_APP_CLIENT_ID,
		siteAlias: runtimeConfig.SITE_ALIAS || import.meta.env.VITE_VUE_APP_SITE_ALIAS,
	...
	getters: {
		...
		// Bad practice. Use hook (useSettingsStore) or map all properties using mapState instead
