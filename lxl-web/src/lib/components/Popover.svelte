...
<!-- 
  @component
	Renders a popover.
	Note that `Popover.svelte` isn't intended to be used directly in page templates – use the `use:popover` or the `use:resourcePopover` action instead (see `$lib/actions/popover` and `$lib/actions/resourcePopover`).
-->
<div
