...
export default {
	...
	search: {
		...
		selectedFiltersOne: 'Selected filters',
		clearFilters: 'Clear',
		editFilters: 'Edit',
		removeFilter: 'Remove filter',
		noFilters: 'No applicable filters',
		filtersMenubar: 'Applicable filters – use arrow keys to navigate between the different filters',
