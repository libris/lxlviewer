...
import { ID_URL, DISPLAY_JSONLD_FROM_LOCAL_FS } from '$env/static/private';
...
async function loadUtil() {
	...
	if (DISPLAY_JSONLD_FROM_LOCAL_FS) {
		...
		console.warn(`DISPLAY_JSONLD_FROM_LOCAL_FS true. Using ${path}`);
	}
