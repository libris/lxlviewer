...
Custom start content (shown when there is no query value) can be defined as a [Snippet](https://svelte.dev/docs/svelte/snippet) passed as a `startContent` prop.
