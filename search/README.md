...
A test project adding some of the functionality from the [Search4 POC](https://github.com/libris/search4), using [Svelte](https://svelte.dev/) and [SvelteKit](https://kit.svelte.dev/) instead of Vue3.
