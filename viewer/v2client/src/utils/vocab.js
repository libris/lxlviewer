...
export function getVocab() {
  return new Promise((resolve, reject) => {
    httpUtil.getResourceFromCache('http://localhost.tech:5000/vocab/data.jsonld').then((result) => {
      resolve(result);
    }, (error) => {
      reject(error);
    });
...
export function getContext() {
  return new Promise((resolve, reject) => {
    httpUtil.getResourceFromCache('http://localhost.tech:5000/context.jsonld').then((result) => {
      resolve(result);
    }, (error) => {
      reject(error);
    });
...
export function getForcedListTerms() {
  return new Promise((resolve, reject) => {
    httpUtil.getResourceFromCache('http://localhost.tech:5000/sys/forcedsetterms.json').then((result) => {
      resolve(result);
    }, (error) => {
      reject(error);
    });
