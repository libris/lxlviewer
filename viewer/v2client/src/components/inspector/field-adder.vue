    ...
    <panel-component @close="hide" v-if="active" class="FieldAdder-panel FieldAdderPanel">
      <template slot="panel-header">
        ...
        <span class="PanelComponent-windowControl">
            <i @click="toggleFullView" v-show="user.settings.forceFullViewPanel" class="fa fa-minus-square"></i>
            <i @click="toggleFullView" v-show="!user.settings.forceFullViewPanel" class="fa fa-plus-square"></i>
